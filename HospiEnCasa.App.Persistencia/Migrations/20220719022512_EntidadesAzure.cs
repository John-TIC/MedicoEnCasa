...
{
    public partial class EntidadesAzure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TarjetaProfesional = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    HorasLaborales = table.Column<int>(type: "int", nullable: true),
                    Parentesco = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
